...
-- CreateEnum
CREATE TYPE "BannerType" AS ENUM ('BANNER', 'PROMO');
...
-- AddForeignKey
ALTER TABLE "OrderProfile" ADD CONSTRAINT "OrderProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
