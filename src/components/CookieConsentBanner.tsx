      ...
      <div className="mx-auto max-w-5xl overflow-hidden rounded-[28px] border border-amber-200/70 bg-white/95 shadow-[0_24px_80px_rgba(23,16,8,0.22)] backdrop-blur-xl">
        <div className="flex flex-col gap-5 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
          <div className="max-w-4xl flex-1">
            <p className="text-center text-xs font-semibold uppercase tracking-[0.35em] text-amber-600 sm:text-left">cookies</p>
            <h2 className="mt-2 text-center text-lg font-semibold text-slate-950 sm:text-left">Мы используем технические cookies</h2>
            ...
            <div className="mt-3 flex flex-wrap gap-3 text-xs font-semibold text-amber-700">
          ...
          <button
            ...
            className="shrink-0 rounded-full bg-slate-950 px-7 py-3 text-sm font-semibold uppercase tracking-[0.25em] text-amber-100 shadow-lg shadow-slate-950/20 transition hover:-translate-y-0.5 hover:bg-amber-500 hover:text-white"
          >
            Принять
          </button>
        </div>
