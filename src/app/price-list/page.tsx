...
export default function PriceListPage() {
  return (
    <InfoPage
      ...
      paragraphs={[
        "Чтобы получить полный прайс-лист в удобном формате, оставьте заявку по телефону +7 916 004-55-22 или на почту domstroy.dmd@mail.ru — менеджер отправит актуальный файл с ценами и наличием.",
