        ...
        <section className="mx-auto max-w-7xl px-4 py-10 md:py-14">
          <div className="grid gap-5 md:grid-cols-3">
            <article className="group rounded-[28px] border border-amber-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-amber-300 hover:shadow-lg">
              ...
              <a href="mailto:info@domstroy.market" className="mt-5 inline-flex text-sm font-semibold text-amber-700 transition hover:text-amber-800">
            ...
            <article className="group rounded-[28px] border border-amber-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-amber-300 hover:shadow-lg">
              ...
              <div className="mt-5 space-y-2 text-sm font-semibold text-amber-700">
                <a href="tel:88002507626" className="block transition hover:text-amber-800">8 800 250 76 26</a>
                <a href="tel:84997025545" className="block transition hover:text-amber-800">8 499 702 55 45</a>
              </div>
            </article>
            ...
            <article className="group rounded-[28px] border border-amber-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-amber-300 hover:shadow-lg">
              ...
              <div className={missingDataClass}>Нужно указать точный адрес магазина или склада самовывоза</div>
            </article>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:py-16">
            <div>
              ...
              <div className="mt-8 grid gap-5 sm:grid-cols-2">
                <div className="rounded-3xl bg-[#f8f4ed] p-5">
                  ...
                  <div className={missingDataClass}>Нужен фактический адрес центрального офиса</div>
                  <div className={missingDataClass}>Нужен график работы офиса</div>
                </div>
                <div className="rounded-3xl bg-[#f8f4ed] p-5">
                  <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Юридическое лицо</p>
                  <div className={missingDataClass}>Нужно полное наименование ООО или ИП</div>
                  <div className={missingDataClass}>Нужны ИНН, КПП и ОГРН/ОГРНИП</div>
                  <div className={missingDataClass}>Нужен юридический адрес</div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[32px] bg-slate-900 p-7 text-white shadow-xl md:p-8">
              ...
              <div className="mt-7 space-y-3">
                <a href="tel:88002507626" className="flex items-center justify-between rounded-2xl bg-white/10 px-4 py-4 text-sm font-semibold transition hover:bg-amber-500 hover:text-slate-950">
                  <span>Бесплатная линия</span>
                  <span>8 800 250 76 26</span>
                </a>
                <a href="tel:84997025545" className="flex items-center justify-between rounded-2xl bg-white/10 px-4 py-4 text-sm font-semibold transition hover:bg-amber-500 hover:text-slate-950">
                  <span>Городской номер</span>
                  <span>8 499 702 55 45</span>
                </a>
                <a href="mailto:info@domstroy.market" className="flex items-center justify-between rounded-2xl bg-white/10 px-4 py-4 text-sm font-semibold transition hover:bg-amber-500 hover:text-slate-950">
                  <span>Электронная почта</span>
                  <span>info@domstroy.market</span>
                </a>
              </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-12 lg:py-16">
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
            <div className="rounded-[32px] border border-amber-100 bg-[#fff8eb] p-7 md:p-8">
              ...
              <div className={missingDataClass}>Нужны адреса всех магазинов и складов</div>
            ...
            <div id="feedback" className="rounded-[32px] border border-slate-200 bg-white p-7 shadow-sm md:p-8">
              ...
              <form action="mailto:info@domstroy.market" method="post" encType="text/plain" className="mt-7 grid gap-4 sm:grid-cols-2">
