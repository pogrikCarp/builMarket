            ...
            <div>
              ...
              <div className="mt-8 grid gap-5 sm:grid-cols-2">
                ...
                <div className="rounded-3xl bg-[#f8f4ed] p-5">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-700">ООО «НерудСтрой»</p>
                  <p className="mt-2 text-sm leading-6 text-slate-700">ИНН 5043063501 / КПП 504301001</p>
                  <p className="mt-2 text-sm leading-6 text-slate-700">ОГРН 1185074001331 / ОКПО 24966339</p>
                  <p className="mt-2 text-sm leading-6 text-slate-700">142202, Московская обл., Серпуховский район, п. Мирный, д. 2А, офис 2</p>
                </div>
              </div>
            </div>
