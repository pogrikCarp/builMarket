    ...
    <main className="min-h-screen bg-[#f6f3ee] px-6 py-16 text-slate-900">
      <div className="mx-auto max-w-5xl rounded-[36px] bg-white/90 p-8 shadow-sm md:p-12">
        ...
        <div className="mt-8 space-y-8 text-base leading-8 text-slate-600">
          <p>
            Настоящая Политика обработки персональных данных (далее – Политика) разработана в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных и меры по обеспечению их безопасности, предпринимаемые ООО «ДробМашЦентр» (далее – Оператор).
          </p>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2">
              <li>Наименование организации/ИП: ООО «ДробМашЦентр»</li>
              <li>Юридический адрес: 142030, Московская область, г.о. Домодедово, с/п Ям, ул. 1-я Зеленовка, д. 39</li>
              <li>Фактический адрес: 142030, Московская область, г.о. Домодедово, с/п Ям, ул. 1-я Зеленовка, д. 39</li>
              <li>Email для запросов: drobmascentr@mail.ru</li>
              <li>Телефон: <a href="tel:+79376217777" className="font-semibold text-amber-700 hover:underline">+7 (937) 621-77-77</a></li>
              <li>Ответственный за обработку данных: Генеральный директор Гамзабеков Элумудин Шабанович</li>
            </ul>
          </section>
        </div>
      </div>
